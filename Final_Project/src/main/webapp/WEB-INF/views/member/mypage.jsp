...
<header class="header" role="banner">
    ...
    <div id="headerLeft" class="header_left">
        ...
        <ul class="left_menu" role="menu">
            <li>
                <a href="#none" class="left_item" role="menuitem" onclick="clickcr(this,'lnb.info','','',event)"
                   aria-current="true">
                    <div class="menu_text on">내 프로필</div>
                </a>
            </li>
            <li>
                <a href="myshop" class="left_item" role="menuitem" onclick="clickcr(this,'lnb.protect','','',event)"
                   aria-current=>
            ...
            <li>
                <div class="row_item mail ">
                    <span id="myLetterEmailRegSpan"
                          class="item_text">${dto.memEmail }</span>
            ...
            <li>
                <div id="phoneNoRegDiv" class="row_item phone ">
                    <span id="phoneNoRegSpan"
                          class="item_text">${dto.memPhone }</span>
<!--                     <button type="button" id="phoneNoRegBtn" class="btn_edit" -->
<!--                             onclick="showPhoneNumberChangePopUp()"> -->
...
<!--                     </button> -->
            ...
            <li>
                <div id="phoneNoRegDiv" class="row_item other ">
                    <span id="phoneNoRegSpan"
                          class="item_text">${dto.memAddress }</span>
...
<div class="subindex_link">
 	<div class="drop_link">
        	<a href="${pageContext.request.contextPath }/member/update" class="btn_link" >
            <span class="text">정보수정</span>
        </a>
    </div>
    <br>
    <div class="drop_link">
        	<a href="${pageContext.request.contextPath }/member/delete" class="btn_link" >
...
<footer class="footer" role="contentinfo">
    <div class="footer_home">
        <ul class="guide_link">
            <li>
                <a href="${pageContext.request.contextPath }/member/logout" onclick="logout()" class="guide_item">
                ...
                <div class="popup_content">
                    ...
                    <div class="contact_edit_popup" style="width:329px;">
                        <h4 class="contact_edit_title">
                                <strong class="bold">조보규님</strong>의 회원정보 중
                                <em class="accent">연락처
                                    이메일</em>을 수정하기 위해
                                인증절차가 필요합니다.
                        </h4>
                        ...
                        <div class="contact_edit_desc">
                            네이버 서비스의 변경/종료 등 대부분의 네이버 안내에 사용합니다.
                        </div>
                        ...
                        <div class="contact_form">
                            ...
                            <a href="javascript:;" id="myLetterEmailAuthGuide" class="link_come"
                               onclick="clickcr(this,'inf.primaryhelp','','',event)">
                                <span class="text">인증번호가 오지 않나요?</span>
                            </a>
                            <div id="myLetterEmailAuthGuideTxt" class="link_come_desc" style="display: none;">
                                네이버가 발송한 메일이 스팸 메일로 분류된 것은 아닌지 확인해 주세요. 스팸 메일함에도 메일이 없다면, 다시 한 번 '인증'을 눌러주세요.
                            </div>
                        ...
                        <button type="button" class="close_popup"
                                onclick="clickcr(this,'inf.primaryx','','',event);hideMyLetterEmailChangePopUp()"><span
            ...
            <div class="popup_layer_inner">
                <div class="popup_content">
                    ...
                    <div class="contact_edit_popup" style="width:329px;">
                        ...
                        <div class="contact_edit_desc">
                            지금 로그인한 네이버 아이디나, 다른 사람의 네이버 아이디는 연락처로 사용하실 수 없습니다. 비상 시 사용할 이메일 정보이니 정확하게 입력해 주세요.
                        </div>
                        ...
                        <div class="contact_form">
                            ...
                            <a href="javascript:;" id="pswdEmailAuthGuide" class="link_come"
                               onclick="clickcr(this,'inf.recoveryhelp','','',event)">
                                <span class="text">인증번호가 오지 않나요?</span>
                            </a>
